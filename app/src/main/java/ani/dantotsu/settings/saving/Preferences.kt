...
enum class PrefName(val data: Pref) {
    ...
    TorrentEnableDLNA(Pref(Location.Player, Boolean::class, false)),
    TorrentFriendlyName(Pref(Location.Player, String::class, "Dantotsu")),
    ...
    TorrentNzbPort(Pref(Location.Player, Int::class, 0)),
    TorrentNzbLogin(Pref(Location.Player, String::class, "")),
    TorrentNzbPassword(Pref(Location.Player, String::class, "")),
    TorrentNzbPoolSize(Pref(Location.Player, Int::class, 4)),
