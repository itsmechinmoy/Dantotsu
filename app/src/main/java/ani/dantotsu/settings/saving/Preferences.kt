...
enum class PrefName(val data: Pref) {
    ...
    LocalAnimeDir(Pref(Location.Irrelevant, String::class, "")),
    LocalMangaDir(Pref(Location.Irrelevant, String::class, "")),
    LocalNovelDir(Pref(Location.Irrelevant, String::class, "")),
