...
enum class PrefName(val data: Pref) {
    ...
    DiscordIconService(Pref(Location.Irrelevant, String::class, "")),
    DiscordLinkService(Pref(Location.Irrelevant, String::class, "")),
    DiscordIconServiceManga(Pref(Location.Irrelevant, String::class, "")),
