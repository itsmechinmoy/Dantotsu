...
Dantotsu एक [Anilist](https://anilist.co/) विशेष क्लाइंट है।

> **Dantotsu (断トツ; Dan-totsu)** का शाब्दिक अर्थ है "सर्वश्रेष्ठ में सर्वश्रेष्ठ" जापानी में। इसे खुद आज़माएं और खुद निर्णय करें!
...
### 🚀 इस रिपॉज़िटरी को स्टार करें ताकि डेवलपर को समर्थन मिले और एप्लिकेशन के विकास को प्रोत्साहन मिले!

## योगदान देना चाहते हैं? 🤝

सभी प्रकार के योगदान का स्वागत है, चाहे वह कोड हो, दस्तावेज़ीकरण हो, ग्राफिक्स हो, डिज़ाइन सुझाव हों या बग रिपोर्ट हों। कृपया GitHub का पूरा उपयोग करें; पुल अनुरोध (Pull Requests) भेजें, ट्यूटोरियल या अन्य सामग्री योगदान करें - जो कुछ भी आपके पास हो, हम उसका उपयोग कर सकते हैं!

आप हमारे अद्भुत समुदाय के साथ जुड़ सकते हैं, नई सुविधाओं का अनुरोध कर सकते हैं, और किसी भी बग या समस्या की रिपोर्ट हमारे Discord सर्वर पर कर सकते हैं। 📣

### आधिकारिक Discord सर्वर 🚀
...
Dantotsu को Unabandon Public License (UPL) के तहत लाइसेंस प्राप्त है। अधिक जानकारी [यहाँ](LICENSE.md) पाई जा सकती है।
