...
<p align="center">
  ...
  <a href="README.hn.md"><img src="https://img.shields.io/badge/lang-Hindi-green" alt="Hindi"></a>
</p>

# **Dantotsu** 🌟

Dantotsu es un cliente exclusivo de [Anilist](https://anilist.co/).

> **Dantotsu (断トツ; Dan-totsu)** literalmente significa "lo mejor de lo mejor" en japonés. ¡Pruébalo tú mismo y decide!
...
### 🚀 ¡DALE UNA ESTRELLA A ESTE REPOSITORIO PARA APOYAR AL DESARROLLADOR Y FOMENTAR EL DESARROLLO DE LA APLICACIÓN!

## ¿QUIERES CONTRIBUIR? 🤝

Todas las contribuciones son bienvenidas, desde código hasta documentación, gráficos, sugerencias de diseño y reportes de errores. Por favor, utiliza GitHub al máximo; contribuye con Pull Requests, tutoriales u otro contenido: lo que sea que tengas para ofrecer, ¡lo podemos usar!

También puedes unirte a nuestra increíble comunidad, solicitar nuevas funciones y reportar cualquier error o problema en nuestro servidor de Discord. 📣
...
Dantotsu está licenciado bajo la Unabandon Public License (UPL). Más información [aquí.](LICENSE.md)
